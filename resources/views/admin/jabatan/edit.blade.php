    ...
    <div class="py-4">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item"><a href="{{ route('jabatan.crud.index') }}">Jabatan</a></li>
        ...
        <div class="col-12 mb-4">
            <div class="card border-0 shadow components-section">
                <div class="card-body">
                    ...
                    {{-- Gunakan @method('PUT') untuk request update --}}
                            ...
                            <div class="col-lg-8 col-sm-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="deskripsi" id="deskripsi" 
                                        ...
                                        rows="4" 
                                        placeholder="Jelaskan ringkasan tugas dan tanggung jawab...">{{ old('deskripsi') ?? $jabatan->deskripsi }}</textarea>
                                    @error('deskripsi') 
                                        <div class="invalid-feedback">{{ $message }}</div> 
                                    @enderror
                                </div>
                                ...
                                <div class="mt-4">
                                    <button type="submit" class="btn btn-success me-2">
                                        <i class="fas fa-sync-alt me-1"></i> Perbarui Jabatan
                                    </button>
